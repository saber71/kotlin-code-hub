...
object CompareEqualHandler : CommandHandler<Compare.Equal, String> {
    override val handleFor: Class<Compare.Equal>
        get() = Compare.Equal::class.java

    override fun handle(command: Compare.Equal): String {
